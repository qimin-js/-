...
module.exports.triangle = function (x, y) {//三角
    let center = Bodies.rectangle(x, y, 50, 50, Object.assign(config, { render: { fillStyle: '#009fcc' } }));
    let left = Bodies.rectangle(x - 50, y, 50, 50, Object.assign(config, { render: { fillStyle: '#009fcc' } }));
    let right = Bodies.rectangle(x + 50, y, 50, 50, Object.assign(config, { render: { fillStyle: '#009fcc' } }));
    let up = Bodies.rectangle(x, y - 50, 50, 50, Object.assign(config, { render: { fillStyle: '#009fcc' } }));
...
module.exports.square = function (x, y) {//正方形
    let center = Bodies.rectangle(x, y, 50, 50, Object.assign(config, { render: { fillStyle: '#f39004' } }));
    let left = Bodies.rectangle(x - 50, y, 50, 50, Object.assign(config, { render: { fillStyle: '#f39004' } }));
    let up = Bodies.rectangle(x, y - 50, 50, 50, Object.assign(config, { render: { fillStyle: '#f39004' } }));
    let leftUp = Bodies.rectangle(x - 50, y - 50, 50, 50, Object.assign(config, { render: { fillStyle: '#f39004' } }))
